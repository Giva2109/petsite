...
MANUAL_PRICE_OVERRIDES: dict[int, float] = {
    ...
    47: 154.90,  # GOLDEN SPECIAL GATOS AD FRANG 10,1 KG
    49: 59.90,   # GOLDEN SPECIAL GATOS AD FRANG 3 KG
    50: 164.90,  # GOLDEN SPECIAL GATOS AD CAST 10,1 KG
    51: 32.90,   # GOLDEN FORM GATOS AD CAST 1 KG (sem SPECIAL na tabela)
    52: 66.90,   # GOLDEN SPECIAL GATOS AD CAST 3 KG
    53: 164.90,  # GOLDEN SPECIAL GATOS AD CAST CARNE 10,1 KG
    54: 66.90,   # GOLDEN SPECIAL GATOS AD CAST CARNE 3 KG
    55: 66.90,   # GOLDEN SPECIAL GATOS AD CAST CARNE 3 KG
}

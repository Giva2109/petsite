...
SELECT 'a0000000-0000-4000-8000-000000000001', 249, 'Purina Pro Plan - Gatos Adultos - Sabor Frango e Arroz - Embalagem 1kg',
       'gatos', 'UniPet', 'Purina',
       71.7, '/assets/products/catalog/purina-proplan-cat-adult-frango.webp', 'Linha Purina. Pro Plan. Gatos Adultos. Sabor Frango e Arroz.',
       '1kg', 7, TRUE
WHERE NOT EXISTS (
...
SELECT 'a0000000-0000-4000-8000-000000000001', 252, 'Purina Dog Chow - Cães Adultos - Porte Médio e Grande - Sabor Carne, Frango e Arroz - Embalagem 15kg',
       'caes', 'UniPet', 'Purina',
       170.0, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. Dog Chow. Cães Adultos. Porte Médio e Grande. Sabor Carne, Frango e Arroz.',
       '15kg', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 282, 'Purina Dog Chow - Cães Adultos - Porte Mini e Pequeno - Saúde Oral - Embalagem 20x45g',
       'caes', 'UniPet', 'Purina',
       198.9, '/assets/products/catalog/purina-dogchow-oral-mini.webp', 'Linha Purina. Dog Chow. Cães Adultos. Porte Mini e Pequeno. Saúde Oral.',
       '20x45g', 25, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 284, 'Purina Alpo - Cães Adultos - Embalagem 18kg',
       'caes', 'UniPet', 'Purina',
       203.94, '/assets/products/catalog/purina-alpo-adulto.webp', 'Linha Purina. Alpo. Adultos.',
       '18kg', 31, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 285, 'Purina Cat Chow - Gatos Castrados - Sabor Frango - Embalagem 2.7kg',
       'gatos', 'UniPet', 'Purina',
       64.74, '/assets/products/catalog/purina-catchow-cast-frango.webp', 'Linha Purina. Cat Chow. Castrados. Frango.',
       '2.7kg', 21, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 286, 'Purina Cat Chow - Gatos Castrados - Sabor Peixe - Embalagem 1kg',
       'gatos', 'UniPet', 'Purina',
       31.14, '/assets/products/catalog/purina-catchow-cast-peixe.webp', 'Linha Purina. Cat Chow. Castrados. Peixe.',
       '1kg', 21, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 287, 'Purina Cat Chow - Gatos Castrados - Sabor Peixe - Embalagem 2.7kg',
       'gatos', 'UniPet', 'Purina',
       64.74, '/assets/products/catalog/purina-catchow-cast-peixe.webp', 'Linha Purina. Cat Chow. Castrados. Peixe.',
       '2.7kg', 21, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 288, 'Purina Dentalife - Cães - Porte Grande - Embalagem 7x196g',
       'caes', 'UniPet', 'Purina',
       184.28, '/assets/products/catalog/purina-dentalife-grande.webp', 'Linha Purina. Dentalife. - Porte Grande.',
       '7x196g', 15, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 289, 'Purina Dentalife - Cães - Embalagem 7x119g',
       'caes', 'UniPet', 'Purina',
       140.05, '/assets/products/catalog/purina-dentalife-media.webp', 'Linha Purina. Dentalife. Cães.',
       '7x119g', 15, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 290, 'Purina Dentalife - Cães - Porte Mini e Pequeno - Embalagem 7x42g',
       'caes', 'UniPet', 'Purina',
       110.11, '/assets/products/catalog/purina-dentalife-pequena.webp', 'Linha Purina. Dentalife. - Porte Mini e Pequeno.',
       '7x42g', 15, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 291, 'Purina Dentalife - Gatos - Embalagem 12x40g',
       'gatos', 'UniPet', 'Purina',
       111.7, '/assets/products/catalog/purina-dentalife-gatos.webp', 'Linha Purina. Dentalife. Gatos.',
       '12x40g', 15, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 292, 'Purina Dog Chow - Cães Adultos - Porte Mini e Pequeno - Sachê - Embalagem 15x100g',
       'caes', 'UniPet', 'Purina',
       54.21, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. Dog Chow. Adultos - Porte Mini e Pequeno. Sachê.',
       '15x100g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 296, 'Purina Dog Chow - Cães Filhotes - Biscoitos - Sabor Frango, Leite - Embalagem 300g',
       'caes', 'UniPet', 'Purina',
       17.76, '/assets/products/catalog/purina-dogchow-puppy-mini.webp', 'Linha Purina. Dog Chow. Filhotes. Biscoitos. Frango, Leite.',
       '300g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 297, 'Purina Dog Chow - Cães Adultos - Porte Médio e Grande - Biscoitos - Sabor Frango - Embalagem 500g',
       'caes', 'UniPet', 'Purina',
       22.31, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. Dog Chow. Adultos - Porte Médio e Grande. Biscoitos. Frango.',
       '500g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 298, 'Purina Dog Chow - Cães Filhotes - Sachê - Sabor Frango - Embalagem 15x100g',
       'caes', 'UniPet', 'Purina',
       54.21, '/assets/products/catalog/purina-dogchow-puppy-med.webp', 'Linha Purina. Dog Chow. Filhotes. Sachê. Frango.',
       '15x100g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 299, 'Purina Dog Chow - Cães - Porte Médio e Grande - Saúde Oral - Embalagem 20x80g',
       'caes', 'UniPet', 'Purina',
       228.8, '/assets/products/catalog/purina-dogchow-oral-mini.webp', 'Linha Purina. Dog Chow. - Porte Médio e Grande. Saúde Oral.',
       '20x80g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 300, 'Purina Dog Chow - Cães - Porte Médio e Grande - Saúde Oral - Embalagem 12x200g',
       'caes', 'UniPet', 'Purina',
       255.68, '/assets/products/catalog/purina-dogchow-oral-mini.webp', 'Linha Purina. Dog Chow. - Porte Médio e Grande. Saúde Oral.',
       '12x200g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 301, 'Purina Dog Chow - Cães - Porte Mini e Pequeno - Saúde Oral - Embalagem 20x105g',
       'caes', 'UniPet', 'Purina',
       314.6, '/assets/products/catalog/purina-dogchow-oral-mini.webp', 'Linha Purina. Dog Chow. - Porte Mini e Pequeno. Saúde Oral.',
       '20x105g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 302, 'Purina Dog Chow - Cães Adultos - Porte Mini e Pequeno - Biscoitos - Sabor Frango - Embalagem 500g',
       'caes', 'UniPet', 'Purina',
       22.31, '/assets/products/catalog/purina-dogchow-adult-mini.webp', 'Linha Purina. Dog Chow. Adultos - Porte Mini e Pequeno. Biscoitos. Frango.',
       '500g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 303, 'Purina Doguitos - Cães - Sabor Carne - Embalagem 20x65g',
       'caes', 'UniPet', 'Purina',
       149.76, '/assets/products/catalog/purina-doguitos-carne.webp', 'Linha Purina. Doguitos. Cães. Carne.',
       '20x65g', 19, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 304, 'Purina Doguitos - Cães - Sabor Frango - Embalagem 20x65g',
       'caes', 'UniPet', 'Purina',
       149.76, '/assets/products/catalog/purina-doguitos-frango.webp', 'Linha Purina. Doguitos. Cães. Frango.',
       '20x65g', 19, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 305, 'Purina Doguitos - Cães - Sabor Linguicinha - Embalagem 20x45g',
       'caes', 'UniPet', 'Purina',
       149.76, '/assets/products/catalog/purina-doguitos-linguica.webp', 'Linha Purina. Doguitos. Cães. Linguicinha.',
       '20x45g', 19, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 306, 'Purina Fancy Feast - Gatos - Casserole - Sabor Salmão, Atum - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-casserole-atum.webp', 'Linha Purina. Fancy Feast. Gatos. Casserole. Salmão, Atum.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 307, 'Purina Fancy Feast - Gatos - Casserole - Sabor Frango, Peru - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-casserole-frango.webp', 'Linha Purina. Fancy Feast. Gatos. Casserole. Frango, Peru.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 308, 'Purina Fancy Feast - Gatos - Demi Glacé - Sabor Carne - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-demi-carne.webp', 'Linha Purina. Fancy Feast. Gatos. Demi Glacé. Carne.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 309, 'Purina Fancy Feast - Gatos - Demi Glacé - Sabor Frango - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-demi-frango.webp', 'Linha Purina. Fancy Feast. Gatos. Demi Glacé. Frango.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 310, 'Purina Fancy Feast - Gatos - Goulash - Sabor Atum - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-goulash-atum.webp', 'Linha Purina. Fancy Feast. Gatos. Goulash. Atum.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 311, 'Purina Fancy Feast - Gatos - Goulash - Sabor Peru - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-goulash-peru.webp', 'Linha Purina. Fancy Feast. Gatos. Goulash. Peru.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 312, 'Purina Fancy Feast - Gatos - Petit Filet - Sabor Carne - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-petit-carne.webp', 'Linha Purina. Fancy Feast. Gatos. Petit Filet. Carne.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 313, 'Purina Fancy Feast - Gatos - Petit Filet - Sabor Salmão - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-petit-salmao.webp', 'Linha Purina. Fancy Feast. Gatos. Petit Filet. Salmão.',
       '15x85g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 314, 'Purina Friskies - Gatos - Sachê - Sabor Atum - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Atum.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 315, 'Purina Friskies - Gatos - Sachê - Sabor Carne - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Carne.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 316, 'Purina Friskies - Gatos - Sachê - Sabor Cordeiro - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Cordeiro.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 317, 'Purina Friskies - Gatos - Sabor Frango, Delícias da Granja - Embalagem 3kg',
       'gatos', 'UniPet', 'Purina',
       59.32, '/assets/products/catalog/purina-friskies-granja.webp', 'Linha Purina. Friskies. Gatos. Frango, Delícias da Granja.',
       '3kg', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 318, 'Purina Friskies - Gatos Filhotes - Sachê - Sabor Carne - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Filhotes. Sachê. Carne.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 319, 'Purina Friskies - Gatos - Sachê - Sabor Frango - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Frango.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 320, 'Purina Friskies - Gatos - Sabor Mar de Sabores - Embalagem 3kg',
       'gatos', 'UniPet', 'Purina',
       59.32, '/assets/products/catalog/purina-friskies-mar.webp', 'Linha Purina. Friskies. Gatos. Mar de Sabores.',
       '3kg', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 321, 'Purina Friskies - Gatos - Sachê - Sabor Peixe - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Peixe.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 322, 'Purina Friskies - Gatos - Sachê - Sabor Peru - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Peru.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 323, 'Purina Friskies - Gatos - Petiscos - Sabor Salmão - Embalagem 15x80g',
       'gatos', 'UniPet', 'Purina',
       178.43, '/assets/products/catalog/purina-friskies-petisco-frango.webp', 'Linha Purina. Friskies. Gatos. Petiscos. Salmão.',
       '15x80g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 324, 'Purina Friskies - Gatos - Sachê - Sabor Salmão - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Salmão.',
       '15x85g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 325, 'Purina Gatsy - Cães - Sabor Carne - Embalagem 20kg',
       'caes', 'UniPet', 'Purina',
       292.37, '/assets/products/catalog/purina-gatsy-carne.webp', 'Linha Purina. Gatsy. Cães. Carne.',
       '20kg', 31, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 326, 'Purina One - Cães - Sachê - Sabor Multiproteínas - Embalagem 15x85g',
       'caes', 'UniPet', 'Purina',
       78.59, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. One. Cães. Sachê. Multiproteínas.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 327, 'Purina One - Cães - Sachê - Sabor Super Foods - Embalagem 15x85g',
       'caes', 'UniPet', 'Purina',
       78.59, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. One. Cães. Sachê. Super Foods.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 328, 'Purina One - Gatos - Sachê - Sabor Multiproteínas - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       92.04, '/assets/products/catalog/purina-catchow-sachet-adult-carne.webp', 'Linha Purina. One. Gatos. Sachê. Multiproteínas.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 329, 'Purina One - Cães - Sachê - Sabor Super Nutrientes - Embalagem 15x85g',
       'caes', 'UniPet', 'Purina',
       78.59, '/assets/products/catalog/purina-dogchow-adult-med-grande.webp', 'Linha Purina. One. Cães. Sachê. Super Nutrientes.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 330, 'Purina One - Gatos - Sachê - Sabor Super Foods - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       92.04, '/assets/products/catalog/purina-catchow-sachet-adult-carne.webp', 'Linha Purina. One. Gatos. Sachê. Super Foods.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 331, 'Purina One - Gatos - Sachê - Sabor Super Nutrientes - Embalagem 15x85g',
       'gatos', 'UniPet', 'Purina',
       92.04, '/assets/products/catalog/purina-catchow-sachet-adult-carne.webp', 'Linha Purina. One. Gatos. Sachê. Super Nutrientes.',
       '15x85g', 11, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 332, 'Purina Pro Plan - Cães - Neurológico - Embalagem 2kg',
       'caes', 'UniPet', 'Purina',
       169.77, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Neurológico.',
       '2kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 333, 'Purina Pro Plan - Cães - Neurológico - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       527.35, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Neurológico.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 334, 'Purina Pro Plan - Cães - Caloria Reduzida - Embalagem 2kg',
       'caes', 'UniPet', 'Purina',
       130.68, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Caloria Reduzida.',
       '2kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 335, 'Purina Pro Plan - Cães - Caloria Reduzida - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       451.61, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Caloria Reduzida.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 336, 'Purina Pro Plan - Cães - Trato Urinário - Embalagem 2kg',
       'caes', 'UniPet', 'Purina',
       130.68, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Trato Urinário.',
       '2kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 337, 'Purina Pro Plan - Cães - Trato Urinário - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       451.61, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Trato Urinário.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 338, 'Purina Pro Plan - Gatos - Trato Urinário - Embalagem 1.5kg',
       'gatos', 'UniPet', 'Purina',
       151.72, '/assets/products/catalog/purina-proplan-cat-urinary.webp', 'Linha Purina. Pro Plan. Gatos. Trato Urinário.',
       '1.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 339, 'Purina Pro Plan - Gatos - Trato Urinário - Embalagem 7.5kg',
       'gatos', 'UniPet', 'Purina',
       422.54, '/assets/products/catalog/purina-proplan-cat-urinary.webp', 'Linha Purina. Pro Plan. Gatos. Trato Urinário.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 340, 'Purina Pro Plan - Gatos - Caloria Reduzida - Embalagem 1.5kg',
       'gatos', 'UniPet', 'Purina',
       151.72, '/assets/products/catalog/purina-proplan-cat-urinary.webp', 'Linha Purina. Pro Plan. Gatos. Caloria Reduzida.',
       '1.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 341, 'Purina Pro Plan - Cães Adultos 7+ - Mente Ativa - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       318.36, '/assets/products/catalog/purina-proplan-activemind.webp', 'Linha Purina. Pro Plan. Adultos 7+. Mente Ativa.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 342, 'Purina Pro Plan - Gatos Adultos 7+ - Embalagem 7.5kg',
       'gatos', 'UniPet', 'Purina',
       304.29, '/assets/products/catalog/purina-proplan-cat-7plus.webp', 'Linha Purina. Pro Plan. Adultos 7+.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 343, 'Purina Pro Plan - Cães Adultos - Sachê - Sabor Carne - Embalagem 15x100g',
       'caes', 'UniPet', 'Purina',
       101.2, '/assets/products/catalog/purina-proplan-sachet-adult-frango.webp', 'Linha Purina. Pro Plan. Adultos. Sachê. Carne.',
       '15x100g', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 344, 'Purina Pro Plan - Cães Filhotes - Porte Mini e Pequeno - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       289.74, '/assets/products/catalog/purina-proplan-puppy-mini.webp', 'Linha Purina. Pro Plan. Filhotes - Porte Mini e Pequeno.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 345, 'Purina Pro Plan - Gatos Castrados - Embalagem 3kg',
       'gatos', 'UniPet', 'Purina',
       161.36, '/assets/products/catalog/purina-proplan-cat-sterilized.webp', 'Linha Purina. Pro Plan. Castrados.',
       '3kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 346, 'Purina Pro Plan - Gatos Castrados - Embalagem 7.5kg',
       'gatos', 'UniPet', 'Purina',
       304.29, '/assets/products/catalog/purina-proplan-cat-sterilized.webp', 'Linha Purina. Pro Plan. Castrados.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 347, 'Purina Pro Plan - Cães - Hipoalergênico - Embalagem 2kg',
       'caes', 'UniPet', 'Purina',
       141.73, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Hipoalergênico.',
       '2kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 348, 'Purina Pro Plan - Cães - Hipoalergênico - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       397.31, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Cães. Hipoalergênico.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 349, 'Purina Pro Plan - Cães - Porte Mini e Pequeno - Caloria Reduzida - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       289.74, '/assets/products/catalog/purina-proplan-reduced-mini.webp', 'Linha Purina. Pro Plan. - Porte Mini e Pequeno. Caloria Reduzida.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 350, 'Purina Pro Plan - Gatos - Hipoalergênico - Embalagem 1.5kg',
       'gatos', 'UniPet', 'Purina',
       165.3, '/assets/products/catalog/purina-proplan-cat-urinary.webp', 'Linha Purina. Pro Plan. Gatos. Hipoalergênico.',
       '1.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 351, 'Purina Dog Chow - Cães Adultos - Porte Mini e Pequeno - Embalagem 2.5kg',
       'caes', 'UniPet', 'Purina',
       49.73, '/assets/products/catalog/purina-dogchow-adult-mini.webp', 'Linha Purina. Dog Chow. Adultos - Porte Mini e Pequeno.',
       '2.5kg', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 352, 'Purina Dog Chow - Cães Filhotes - Porte Mini e Pequeno - Embalagem 2.5kg',
       'caes', 'UniPet', 'Purina',
       52.17, '/assets/products/catalog/purina-dogchow-puppy-mini.webp', 'Linha Purina. Dog Chow. Filhotes - Porte Mini e Pequeno.',
       '2.5kg', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 353, 'Purina Dog Chow - Cães Filhotes - Porte Mini e Pequeno - Embalagem 900g',
       'caes', 'UniPet', 'Purina',
       20.05, '/assets/products/catalog/purina-dogchow-puppy-mini.webp', 'Linha Purina. Dog Chow. Filhotes - Porte Mini e Pequeno.',
       '900g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 354, 'Purina Pro Plan - Cães - Porte Mini e Pequeno - LiveClear Redução de Alérgenos - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       306.61, '/assets/products/catalog/purina-proplan-adult-grande.webp', 'Linha Purina. Pro Plan. - Porte Mini e Pequeno. LiveClear Redução de Alérgenos.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 355, 'Purina Pro Plan - Cães - Porte Médio e Grande - Caloria Reduzida - Embalagem 10.1kg',
       'caes', 'UniPet', 'Purina',
       275.26, '/assets/products/catalog/purina-proplan-reduced-med.webp', 'Linha Purina. Pro Plan. - Porte Médio e Grande. Caloria Reduzida.',
       '10.1kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 356, 'Purina Pro Plan - Cães - Porte Médio e Grande - LiveClear Redução de Alérgenos - Embalagem 10.1kg',
       'caes', 'UniPet', 'Purina',
       275.26, '/assets/products/catalog/purina-proplan-adult-grande.webp', 'Linha Purina. Pro Plan. - Porte Médio e Grande. LiveClear Redução de Alérgenos.',
       '10.1kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 357, 'Purina Pro Plan - Cães Adultos 7+ - Porte Mini e Pequeno - Longevidade - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       292.66, '/assets/products/catalog/purina-proplan-activemind.webp', 'Linha Purina. Pro Plan. Adultos 7+ - Porte Mini e Pequeno. Longevidade.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 358, 'Purina Pro Plan - Cães - Paladar Exigente - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       306.61, '/assets/products/catalog/purina-proplan-adult-mini.webp', 'Linha Purina. Pro Plan. Cães. Paladar Exigente.',
       '7.5kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 359, 'Purina Pro Plan - Cães - Alta Vitalidade - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       297.3, '/assets/products/catalog/purina-proplan-adult-grande.webp', 'Linha Purina. Pro Plan. Cães. Alta Vitalidade.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 360, 'Purina Pro Plan - Cães Adultos - Porte Grande - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       297.3, '/assets/products/catalog/purina-proplan-adult-grande.webp', 'Linha Purina. Pro Plan. Adultos - Porte Grande.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 361, 'Purina Pro Plan - Cães Adultos - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       297.3, '/assets/products/catalog/purina-proplan-adult-medio.webp', 'Linha Purina. Pro Plan. Adultos.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 362, 'Purina Pro Plan - Cães Adultos 7+ - Longevidade - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       312.17, '/assets/products/catalog/purina-proplan-activemind.webp', 'Linha Purina. Pro Plan. Adultos 7+. Longevidade.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 363, 'Purina Pro Plan - Gatos Adultos 7+ - Embalagem 3kg',
       'gatos', 'UniPet', 'Purina',
       190.81, '/assets/products/catalog/purina-proplan-cat-7plus.webp', 'Linha Purina. Pro Plan. Adultos 7+.',
       '3kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 364, 'Purina Pro Plan - Gatos - Trato Urinário - Embalagem 3kg',
       'gatos', 'UniPet', 'Purina',
       199.89, '/assets/products/catalog/purina-proplan-cat-urinary.webp', 'Linha Purina. Pro Plan. Gatos. Trato Urinário.',
       '3kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 365, 'Purina Friskies - Gatos - Sachê - Sabor Carne, Mix de Carnes - Embalagem 15x80g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Carne, Mix de Carnes.',
       '15x80g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 366, 'Purina Friskies - Gatos - Sachê - Sabor Mar de Sabores - Embalagem 15x80g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Mar de Sabores.',
       '15x80g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 367, 'Purina Friskies - Gatos - Sachê - Sabor Mix de Carnes, Megamix - Embalagem 15x80g',
       'gatos', 'UniPet', 'Purina',
       54.41, '/assets/products/catalog/purina-friskies-mix-carnes.webp', 'Linha Purina. Friskies. Gatos. Sachê. Mix de Carnes, Megamix.',
       '15x80g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 368, 'Purina Dog Chow - Cães Filhotes - Porte Médio e Grande - Embalagem 2.5kg',
       'caes', 'UniPet', 'Purina',
       52.17, '/assets/products/catalog/purina-dogchow-puppy-med.webp', 'Linha Purina. Dog Chow. Filhotes - Porte Médio e Grande.',
       '2.5kg', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 369, 'Purina Dog Chow - Cães Filhotes - Porte Médio e Grande - Embalagem 900g',
       'caes', 'UniPet', 'Purina',
       20.05, '/assets/products/catalog/purina-dogchow-puppy-med.webp', 'Linha Purina. Dog Chow. Filhotes - Porte Médio e Grande.',
       '900g', 23, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 370, 'Purina Friskies - Gatos Castrados - Sabor Mix de Carnes, Megamix - Embalagem 2.5kg',
       'gatos', 'UniPet', 'Purina',
       49.44, '/assets/products/catalog/purina-friskies-megamix.webp', 'Linha Purina. Friskies. Castrados. Mix de Carnes, Megamix.',
       '2.5kg', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 371, 'Purina Friskies - Gatos - Sabor Mar de Sabores - Embalagem 850g',
       'gatos', 'UniPet', 'Purina',
       21.14, '/assets/products/catalog/purina-friskies-mar.webp', 'Linha Purina. Friskies. Gatos. Mar de Sabores.',
       '850g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 372, 'Purina Friskies - Gatos - Sabor Frango, Delícias da Granja - Embalagem 850g',
       'gatos', 'UniPet', 'Purina',
       21.14, '/assets/products/catalog/purina-friskies-granja.webp', 'Linha Purina. Friskies. Gatos. Frango, Delícias da Granja.',
       '850g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 373, 'Purina Friskies - Gatos Castrados - Sabor Mix de Carnes, Megamix - Embalagem 850g',
       'gatos', 'UniPet', 'Purina',
       21.14, '/assets/products/catalog/purina-friskies-megamix.webp', 'Linha Purina. Friskies. Castrados. Mix de Carnes, Megamix.',
       '850g', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 374, 'Purina Fancy Feast - Gatos - Supremo - Sabor Bacalhau - Embalagem 15x75g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-supremo-bacalhau.webp', 'Linha Purina. Fancy Feast. Gatos. Supremo. Bacalhau.',
       '15x75g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 375, 'Purina Fancy Feast - Gatos - Supremo - Sabor Carne - Embalagem 15x75g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-supremo-carne.webp', 'Linha Purina. Fancy Feast. Gatos. Supremo. Carne.',
       '15x75g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 376, 'Purina Friskies - Gatos - Sabor Mar de Sabores - Embalagem 2.5kg',
       'gatos', 'UniPet', 'Purina',
       741.59, '/assets/products/catalog/purina-friskies-mar.webp', 'Linha Purina. Friskies. Gatos. Mar de Sabores.',
       '2.5kg', 27, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 377, 'Purina Pro Plan - Cães Filhotes - Porte Grande - Desempenho Excepcional - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       312.17, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Filhotes - Porte Grande. Desempenho Excepcional.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 378, 'Purina Pro Plan - Cães Filhotes - Desempenho Excepcional - Embalagem 12kg',
       'caes', 'UniPet', 'Purina',
       312.17, '/assets/products/catalog/purina-proplan-puppy-grande.webp', 'Linha Purina. Pro Plan. Filhotes. Desempenho Excepcional.',
       '12kg', 5, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 380, 'Purina Fancy Feast - Gatos - Supremo - Sabor Peixe - Embalagem 15x75g',
       'gatos', 'UniPet', 'Purina',
       87.17, '/assets/products/catalog/purina-fancy-supremo-peixe.webp', 'Linha Purina. Fancy Feast. Gatos. Supremo. Peixe.',
       '15x75g', 17, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 381, 'Purina Pro Plan - Gatos Castrados - Sterilised - Embalagem 7.5kg',
       'gatos', 'UniPet', 'Purina',
       319.55, '/assets/products/catalog/purina-proplan-cat-sterilized.webp', 'Linha Purina. Pro Plan. Castrados.',
       '7.5kg', 7, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 382, 'Purina Pro Plan - Cães Adultos 7+ - Embalagem 7.5kg',
       'caes', 'UniPet', 'Purina',
       335.54, '/assets/products/catalog/purina-proplan-cat-7plus.webp', 'Linha Purina. Pro Plan. Adultos 7+.',
       '7.5kg', 7, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
...
SELECT 'a0000000-0000-4000-8000-000000000001', 383, 'Purina Pro Plan - Gatos Filhotes - Desempenho Excepcional - Embalagem 7.5kg',
       'gatos', 'UniPet', 'Purina',
       335.54, '/assets/products/catalog/purina-proplan-cat-kitten.webp', 'Linha Purina. Pro Plan. Filhotes. Desempenho Excepcional.',
       '7.5kg', 7, TRUE
WHERE NOT EXISTS (
  SELECT 1 FROM products
  WHERE tenant_id = 'a0000000-0000-4000-8000-000000000001'
